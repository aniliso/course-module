        ...
        <div class="col-md-3">
            <div class="box">
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-6">
                            {!! Form::normalInput("age", trans("course::courses.form.age"), $errors) !!}
                        </div>
                        <div class="col-md-6">
                            {!! Form::normalInput("capacity", trans("course::courses.form.capacity"), $errors) !!}
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has("end_at") ? ' has-error' : '' }}">
                                ...
                                <div class='input-group date' id='end_at'>
                                    <input type="text" class="form-control" name="end_at" value="{{ old('end_at', Carbon::tomorrow()->format('d.m.Y')) }}" />
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has("start_hour") ? ' has-error' : '' }}">
                                ...
                                <div class='input-group date' id='start_hour'>
                                    <input type="text" class="form-control" name="start_hour" value="{{ old('start_hour', "09:00") }}" />
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has("end_hour") ? ' has-error' : '' }}">
                                ...
                                <div class='input-group date' id='end_hour'>
                                    <input type='text' class="form-control" name="end_hour" value="{{ old('end_hour', "10:00") }}"/>
                                    <span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('day[]', DaysOfWeek::lists(), old("days"), ['class'=>'form-control select2', 'multiple'=>'multiple']) !!}
                        {!! $errors->first("day", '<span class="help-block">:message</span>') !!}
                    </div>

                    {!! Form::normalInput("price", trans("course::courses.form.price"), $errors) !!}
            ...
            <div class="box">
                <div class="box-body">
                    ...
                    @mediaSingle('courseImage', null, null, trans('course::courses.form.image'))
                </div>
            </div>
        </div>
    </div>
